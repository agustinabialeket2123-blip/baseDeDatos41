# Auto Service
Planteamos una base de datos para un sistema de reserva de vehículos en linea. En este modelo se plantea al cliente, al chofer, su vehículo y las reservas junto con su pago.
### Integrantes:
- Agustina Bialek
- Amanda Ortega Franco
- Morena Echeverría Secco
- Matías Ojcius

## M.E.R. (Diagrama de flujo):
![alt text](mer.png)

## Modelo Físico:
![alt text](modeloFisico.svg)
